...
class SupabaseService {
  constructor(memoryService) {
    ...
    this.config = {
      url: '',
      anonKey: '',
      authRedirectUrl: 'auth-callback.html'
    };
  ...
  async init() {
    try {
      ...
      if (error) {
        console.warn('Error getting session during init:', error.message);
  ...
  async signInWithProvider(provider, options = {}) {
    ...
    try {
      ...
      oauthOptions.options.redirectTo = redirectTo || 'auth-callback.html';
