...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-message { color: #f87171; background: #3c1a1a; padding: 8px; border-radius: 4px; margin: 8px 0; }
        .success-message { color: #10b981; background: #1a3c2a; padding: 8px; border-radius: 4px; margin: 8px 0; }
    ...
    <div class="container">
        <div class="card">
            ...
            async sendAIMessage() {
                ...
                try {
                    // Get current editor content and context
                    ...
                    const currentLanguage = this.currentFile && this.openFiles.has(this.currentFile) 
                        ? this.openFiles.get(this.currentFile).language 
                        : 'plaintext';
