        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-600 max-w-md">
              AI-powered website editing platform. Update your legacy website instantly with natural language—no coding experience needed.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="mailto:support@ezedit.co" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
                  Contact Support
                </a>
              </li>
            </ul>
